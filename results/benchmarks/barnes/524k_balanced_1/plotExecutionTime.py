...
ax.plot(NUM_PR,global_median_comm,'--s')
ax.plot(NUM_PR,global_median_comp,'--x')
ax.plot(NUM_PR,global_median_gather,'--^')
ax.plot(NUM_PR,global_median_tree,'--*')
...
plt.ylim(0.001, 700)
#plt.show()
plt.savefig("500k05EXEC.eps",transparent=True)
